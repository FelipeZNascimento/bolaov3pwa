...
export const fetchDefaultConfig =
  () => async (dispatch: Dispatch<TFetchConfig>) => {
...
export const fetchRanking =
  ...
  async (dispatch: Dispatch<TFetchRanking>) => {
...
export const fetchSeasonRanking =
  (season: number) => async (dispatch: Dispatch<TFetchRanking>) => {
...
export const setCurrentWeek =
  (week: number) => async (dispatch: Dispatch<TSetWeek>) => {
    return dispatch({
...
export const onClearNotification =
  (id: string) => async (dispatch: Dispatch<TClearNotification>) => {
    return dispatch({
