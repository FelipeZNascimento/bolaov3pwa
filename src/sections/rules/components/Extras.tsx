    ...
    return (
        <div className={styles.internalRules}>
            ...
            <div className={styles.text}>
                Apostas específicas sobre o campeão de cada divisão, de cada conferência e o vencedor do Super Bowl.<br />
                Essas apostas ficarão habilitadas até <b>{DateTime.fromSeconds(1631233200).setLocale('pt-Br').toFormat("EEE dd/LL, HH'h'mm")}</b>.<br /><br />
                <Link to={ROUTES.EXTRAS.url}>Clique aqui</Link> para fazer suas apostas extras.<br /><br />
            </div>
