...
import { selectCurrentSeason, selectSeasonStart } from 'store/app/selector';
...
const ExtraBets = () => {
  ...
  const [extraSection, setExtraSection] = useState<EXTRA_SECTION_TYPE>(
    EXTRA_SECTION.AFC
  );
    ...
    <div className={containerClass}>
      ...
      <div className={styles.buttonsContainer}>
        <Button
          classes={{
            root: `${
              extraSection === EXTRA_SECTION.AFC
                ? styles.buttonActive
                : styles.button
            }`
          }}
        ...
        <Button
          classes={{
            root: `${
              extraSection === EXTRA_SECTION.NFC
                ? styles.buttonActive
                : styles.button
            }`
          }}
        ...
        <Button
          classes={{
            root: `${
              extraSection === EXTRA_SECTION.PLAYOFFS
                ? styles.buttonActive
                : styles.button
            }`
          }}
      ...
      {hasSeasonStarted && (
        <AfterSeasonStart selectedExtraSection={extraSection} />
      )}
